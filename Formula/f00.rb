...
class F00 < Formula
  ...
  on_linux do
    on_intel do
      url "https://github.com/theesfeld/f00/releases/download/v#{version}/f00-0.16.6-linux-x86_64.tar.gz"
      sha256 "5e5a389385395b2585670a737be17cd7ed95c644c88e10f1cc9ebaa4f1ac0e89"
    end
  end
