...
class F00 < Formula
  ...
  on_linux do
    on_intel do
      url "https://github.com/theesfeld/f00/releases/download/v#{version}/f00-0.15.14-linux-x86_64.tar.gz"
      sha256 "398b895a043e45331855a56d0b2bd826c1be4b3d45dbb450faf0595d43f10eb1"
    end
  end
