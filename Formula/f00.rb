...
class F00 < Formula
  ...
  on_linux do
    on_intel do
      url "https://github.com/theesfeld/f00/releases/download/v#{version}/f00-0.15.9-linux-x86_64.tar.gz"
      sha256 "f0be4c33e6b9680564ae793ffb6e3806e4bf8fb464dffb8dcf4719fd9f05d98a"
    end
  end
