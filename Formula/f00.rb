...
class F00 < Formula
  ...
  on_linux do
    on_intel do
      url "https://github.com/theesfeld/f00/releases/download/v#{version}/f00-0.16.7-linux-x86_64.tar.gz"
      sha256 "29250c4897374f1aa59e97c77ce605883207dcfd4f00fdb384db2402de2f76a5"
    end
  end
