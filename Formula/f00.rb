...
class F00 < Formula
  ...
  on_linux do
    on_intel do
      url "https://github.com/theesfeld/f00/releases/download/v#{version}/f00-0.16.8-linux-x86_64.tar.gz"
      sha256 "daeccbc440be7377d7a3b563f9ef3cec55655c9ba7dcf30b1ababb84d0685550"
    end
  end
