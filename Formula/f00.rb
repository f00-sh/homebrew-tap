...
class F00 < Formula
  ...
  on_linux do
    on_intel do
      url "https://github.com/theesfeld/f00/releases/download/v#{version}/f00-0.15.3-linux-x86_64.tar.gz"
      sha256 "6106b31edce7a1edb0c6ae71527bcd2d5d0b9511644f665b9d3597cde87e4480"
    end
  end
