...
class F00 < Formula
  ...
  on_linux do
    on_intel do
      url "https://github.com/theesfeld/f00/releases/download/v#{version}/f00-0.15.13-linux-x86_64.tar.gz"
      sha256 "85eb72fdaff498a426b3f986e40349068c272d6a8b083cae46de0e12eb86c5b6"
    end
  end
