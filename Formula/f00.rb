...
class F00 < Formula
  ...
  on_linux do
    on_intel do
      url "https://github.com/theesfeld/f00/releases/download/v#{version}/f00-0.15.16-linux-x86_64.tar.gz"
      sha256 "c0bbdaddc6331e48dec0dcc6b9d92919832dad42ef2ded357977df076c3bffc2"
    end
  end
