...
class F00 < Formula
  ...
  on_linux do
    on_intel do
      url "https://github.com/theesfeld/f00/releases/download/v#{version}/f00-0.16.2-linux-x86_64.tar.gz"
      sha256 "09f9e0601b67daf44b7b694a2a98515b717efb1ebc331fdbfaed6be16e6aacd3"
    end
  end
