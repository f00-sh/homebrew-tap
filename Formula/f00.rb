...
class F00 < Formula
  ...
  on_linux do
    on_intel do
      url "https://github.com/theesfeld/f00/releases/download/v#{version}/f00-0.15.10-linux-x86_64.tar.gz"
      sha256 "3f2e1803fa27a6bba9a0580d5aad532ade5f4479953c78cae572e477c247699a"
    end
  end
