...
class F00 < Formula
  ...
  on_linux do
    on_intel do
      url "https://github.com/theesfeld/f00/releases/download/v#{version}/f00-0.15.4-linux-x86_64.tar.gz"
      sha256 "ac2e372e93c57ca021659aac3cf60af0b5e492d216c7419b9d953fb029c803aa"
    end
  end
