...
class F00 < Formula
  ...
  on_linux do
    on_intel do
      url "https://github.com/theesfeld/f00/releases/download/v#{version}/f00-0.16.4-linux-x86_64.tar.gz"
      sha256 "9325ddfaa5356cb38f55a68e643c1b7ae37ff0d7e012948114268be8c099fb31"
    end
  end
