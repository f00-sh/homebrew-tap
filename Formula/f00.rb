...
class F00 < Formula
  ...
  on_linux do
    on_intel do
      url "https://github.com/theesfeld/f00/releases/download/v#{version}/f00-0.15.5-linux-x86_64.tar.gz"
      sha256 "c2b3025b724ded24abffebd82bb03906d0e85991a7d9625bc5a446fffec6b151"
    end
  end
