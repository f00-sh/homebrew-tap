...
class F00 < Formula
  ...
  on_linux do
    on_intel do
      url "https://github.com/theesfeld/f00/releases/download/v#{version}/f00-0.15.17-linux-x86_64.tar.gz"
      sha256 "05792ec842edf7a6a0bba6875a7c459e76ecc2bef8fd52a10af10c82c710e1b8"
    end
  end
