...
class F00 < Formula
  ...
  on_linux do
    on_intel do
      url "https://github.com/theesfeld/f00/releases/download/v#{version}/f00-0.15.15-linux-x86_64.tar.gz"
      sha256 "87a94a8481788ab490f241c54c2a3262ba8337f56e40d18714917f5d322ce598"
    end
  end
