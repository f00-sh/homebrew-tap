...
class F00 < Formula
  ...
  on_linux do
    on_intel do
      url "https://github.com/theesfeld/f00/releases/download/v#{version}/f00-0.15.21-linux-x86_64.tar.gz"
      sha256 "2e7bec7484ead2ffc22f0ea04cfdacba290bb69927dc059197baf552a965332b"
    end
  end
